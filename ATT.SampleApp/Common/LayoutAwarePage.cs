// <copyright file="LayoutAwarePage.cs" company="AT&amp;T">
...
namespace ATT.SampleApp.Common
{
	/// <summary>
	...
	public class LayoutAwarePage : Page
	{
		...
		/// <summary>
		/// Implementation of IObservableMap that supports reentrant for use as a default view
		/// model.
		/// </summary>
