...
namespace ATT.Controls.SubControls
{
	...
	public class FileOpenPickerControl : Control
	{
		...
		private readonly string[] _audioExtensions = new[] { ".amr", ".wav", ".mp3", ".aifc", ".aiff", ".au", ".imy", ".m4a" };
		...
		/// </summary>
		public static readonly DependencyProperty MaxNewFilesSizeProperty = DependencyProperty.Register("MaxNewFilesSize", typeof(ulong), typeof(FileOpenPickerControl), new PropertyMetadata(0));
		...
		private async Task<bool> CheckSize(StorageFile file, IEnumerable<StorageFile> files)
		{
			...
			return MaxNewFilesSize == 0 || currentSize <= MaxNewFilesSize;
		}
	}
}
